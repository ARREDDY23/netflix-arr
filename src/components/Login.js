  ...
  return (
    <div className="">
        <div className="absolute">
            <Header />
            <img className="h-screen object-cover md:hidden" src="https://assets.nflxext.com/ffe/siteui/vlv3/c1366fb4-3292-4428-9639-b73f25539794/3417bf9a-0323-4480-84ee-e1cb2ff0966b/IN-en-20240408-popsignuptwoweeks-perspective_alpha_website_large.jpg" alt="Login Background"/>
        
            <img className="hidden md:inline-block" src="https://assets.nflxext.com/ffe/siteui/vlv3/c1366fb4-3292-4428-9639-b73f25539794/3417bf9a-0323-4480-84ee-e1cb2ff0966b/IN-en-20240408-popsignuptwoweeks-perspective_alpha_website_large.jpg" alt="Login Background"/>
        </div>
        <form onSubmit={(e) => e.preventDefault()} className="absolute w-full bg-black md:w-3/12 p-12 my-32 mx-auto right-0 left-0 text-white bg-opacity-70">
            ...
            <p className='my-6 cursor-pointer' onClick={signinuphandler}>{isSignInForm ? "New to Netflix? Sign Up now." : "Already a member? Sign In "}</p>
        </form>
    </div>
  )
}
